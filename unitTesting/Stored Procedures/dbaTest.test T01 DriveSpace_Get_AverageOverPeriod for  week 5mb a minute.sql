...
CREATE   PROCEDURE [dbaTest].[test T01 DriveSpace_Get_AverageOverPeriod for  week 5mb a minute]
AS
BEGIN
    /*Cleanup*/
    ...
    /*insert sample data*/
    DECLARE @StartDate DATETIME = '01/01/2024',
            @EndDate DATETIME = DATEADD(SECOND, -1, '01/08/2024'),
